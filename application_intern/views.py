...
from yuzzaz.models import ApplicationSettings
...
def intro_view(request):
    ...
    early_deadline = app_settings.early_consideration_deadline
    regular_deadline = app_settings.regular_consideration_deadline
